	            ...
	            <div class="row">
		            <form action="" id="projectForm" class="form-horizontal">
						...
						<div class="form-group">
				             ...
				             <div class="col-sm-2">
				             	<input type="text" class="form-control" id="projName" name="projName" value="${project.projName }" onmouseover="this.title=this.value"/>
				             </div>
						...
						<div class="form-group" >
				             ...
				             <div class="col-sm-2">
				             	<input type="text" class="form-control" id="busName" name="busName"  value="${project.busName }" onmouseover="this.title=this.value"/>
				             </div>
				             <div>
