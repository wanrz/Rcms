...
<html>
  <head>
    ...
    <link href="files/项目详情/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/项目详情/data.js"></script>
  ...
  <body>
    <div id="base" class="">
      ...
      <!-- Unnamed (文本框) -->
      <div id="u120" class="ax_default _文本框">
      ...
      <!-- Unnamed (文本框) -->
      <div id="u123" class="ax_default _文本框">
      ...
      <div id="u124" class="ax_default _形状">
        ...
        <div id="u125" class="text" style="visibility: visible;">
          <p><span>客户方联系人：</span></p>
        </div>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u126" class="ax_default _文本框">
        <input id="u126_input" type="text" value=""/>
      </div>

      <!-- Unnamed (提交按钮) -->
      <div id="u127" class="ax_default _提交按钮">
        <input id="u127_input" type="submit" value="返回"/>
      </div>
      ...
      <!-- Unnamed (文本框) -->
      <div id="u130" class="ax_default _文本框">
      ...
      <!-- Unnamed (文本框) -->
      <div id="u133" class="ax_default _文本框">
      ...
      <div id="u134" class="ax_default _形状">
        ...
        <div id="u135" class="text" style="visibility: visible;">
          <p><span>实现销售概率：</span></p>
        </div>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u136" class="ax_default _文本框">
      ...
      <div id="u137" class="ax_default _形状">
        ...
        <div id="u138" class="text" style="visibility: visible;">
          <p><span>销售可能性趋势：</span></p>
        </div>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u139" class="ax_default _文本框">
      ...
      <!-- Unnamed (文本框) -->
      <div id="u142" class="ax_default _文本框">
      ...
      <!-- Unnamed (文本框) -->
      <div id="u145" class="ax_default _文本框">
      ...
      <!-- Unnamed (文本框) -->
      <div id="u148" class="ax_default _文本框">
      ...
      <!-- Unnamed (文本框) -->
      <div id="u151" class="ax_default _文本框">
      ...
      <!-- Unnamed (文本框) -->
      <div id="u154" class="ax_default _文本框">
        <input id="u154_input" type="text" value=""/>
      </div>

      <!-- Unnamed (水平线) -->
      <div id="u155" class="ax_default line">
        <img id="u155_img" class="img " src="images/项目详情/u155.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u157" class="ax_default line">
        <img id="u157_img" class="img " src="images/项目详情/u157.png"/>
        <!-- Unnamed () -->
