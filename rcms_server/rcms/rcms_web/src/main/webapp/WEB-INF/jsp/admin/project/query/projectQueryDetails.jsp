...
$(function(){
	...
	window.setOperator = function(obj,createUserId){
		...
		attend_btn.click(function(){
			...
			$("#projectForm").attr("action","<%=request.getContextPath()%>/admin/projectQuery/contrast.do");
			$("#projectForm").submit();
		});
	...
	$("#myTable").createTable({
		...
		url:"<%=request.getContextPath()%>/admin/projectQuery/projectDetails.ajax",//请求数据地址（必须）
    ...
    <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-info">
        	...
        	<div class="row">
        	     <div class="box-header with-border" style="margin-left: 16px;">
	            ...
	            <div class="box box-info" style="margin-left: 16px;">
	            </div>
