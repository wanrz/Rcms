...
Class.pt.config = {
    ...
    loading: {type: 0},
    tips: {msg: '', follow: '', guide: 0, isGuide: true, style:["background-color:#FFF9DE;color:#333;height:24px;line-height:24px;border:1px solid #ECC896",""],maxwidth:300},
